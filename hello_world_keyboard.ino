...
int matrix[] = {
  ...
  KEY_MOUSE_MODE, KEY_LEFT_GUI, KEY_LEFT_CTRL, KEY_LEFT_ALT, KEY_LAYER_DOWN, KEY_SPACE, KEY_SPACE, KEY_LEFT_SHIFT, KEY_RIGHT_ALT, EMPTY, KEY_LEFT_ARROW, KEY_DOWN_ARROW, KEY_RIGHT_ARROW
};
